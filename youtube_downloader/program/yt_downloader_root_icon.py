...
root.tk.call('wm', 'iconphoto', root._w, PhotoImage(file='/yt_downloader/icons/yt-icon.png'))
...
def saveFile():
    ...
    if filePath != "":
        ...
        top.tk.call('wm', 'iconphoto', top._w, PhotoImage(file='/yt_downloader/icons/folder.png'))
        ...
        def DownloadVideo():
            try:
                try:
                    ...
                    top.tk.call('wm', 'iconphoto', top._w, PhotoImage(file='/yt_downloader/icons/green-check.png'))
                    ...
                    top.tk.call('wm', 'iconphoto', top._w, PhotoImage(file='/yt_downloader/icons/error.png'))
...
def helpf():
    Htop = Toplevel()
    Htop.tk.call('wm', 'iconphoto', Htop._w, PhotoImage(file='/yt_downloader/icons/help-icon.png'))
...
# Image
img = tkinter.PhotoImage(file='/yt_downloader/icons/yt-image-small.png')
